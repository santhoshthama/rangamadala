      ...
      <div class="register-content">
        <div class="alert-info">
          ...
          <div class="alert-info-text">
            Fill the required account details now. You can add full service details after admin approval.
          </div>
        </div>
        ...
        <form id="serviceForm" action="<?= ROOT ?>/ServiceProviderRegister/submit" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-page">
            <div class="section">
              ...
              <div class="service-item"><div class="checkbox-group"><input type="checkbox" name="services[0][selected]" class="checkbox" id="service1" <?= !empty($svc0['selected']) ? 'checked' : '' ?>><label for="service1" class="service-name">Theater Production</label><input type="hidden" name="services[0][name]" value="Theater Production"></div></div>

              <?php $svc1 = $servicesData[1] ?? []; ?>
              <div class="service-item"><div class="checkbox-group"><input type="checkbox" name="services[1][selected]" class="checkbox" id="service2" <?= !empty($svc1['selected']) ? 'checked' : '' ?>><label for="service2" class="service-name">Lighting Design</label><input type="hidden" name="services[1][name]" value="Lighting Design"></div></div>

              <?php $svc2 = $servicesData[2] ?? []; ?>
              <div class="service-item"><div class="checkbox-group"><input type="checkbox" name="services[2][selected]" class="checkbox" id="service3" <?= !empty($svc2['selected']) ? 'checked' : '' ?>><label for="service3" class="service-name">Sound Systems</label><input type="hidden" name="services[2][name]" value="Sound Systems"></div></div>

              <?php $svc3 = $servicesData[3] ?? []; ?>
              <div class="service-item"><div class="checkbox-group"><input type="checkbox" name="services[3][selected]" class="checkbox" id="service4" <?= !empty($svc3['selected']) ? 'checked' : '' ?>><label for="service4" class="service-name">Video Production</label><input type="hidden" name="services[3][name]" value="Video Production"></div></div>

              <?php $svc4 = $servicesData[4] ?? []; ?>
              <div class="service-item"><div class="checkbox-group"><input type="checkbox" name="services[4][selected]" class="checkbox" id="service5" <?= !empty($svc4['selected']) ? 'checked' : '' ?>><label for="service5" class="service-name">Set Design</label><input type="hidden" name="services[4][name]" value="Set Design"></div></div>

              <?php $svc5 = $servicesData[5] ?? []; ?>
              <div class="service-item"><div class="checkbox-group"><input type="checkbox" name="services[5][selected]" class="checkbox" id="service6" <?= !empty($svc5['selected']) ? 'checked' : '' ?>><label for="service6" class="service-name">Costume Design</label><input type="hidden" name="services[5][name]" value="Costume Design"></div></div>

              <?php $svc6 = $servicesData[6] ?? []; ?>
              <div class="service-item"><div class="checkbox-group"><input type="checkbox" name="services[6][selected]" class="checkbox" id="service7" <?= !empty($svc6['selected']) ? 'checked' : '' ?>><label for="service7" class="service-name">Makeup & Hair</label><input type="hidden" name="services[6][name]" value="Makeup & Hair"></div></div>

              <?php $svc7 = $servicesData[7] ?? []; ?>
              <div class="service-item"><div class="checkbox-group"><input type="checkbox" name="services[7][selected]" class="checkbox" id="service8" <?= !empty($svc7['selected']) ? 'checked' : '' ?>><label for="service8" class="service-name">Other</label><input type="hidden" name="services[7][name]" value="Other"></div></div>
            </div>
